...
if(isset($_POST['submit'])){
    ...
    if(!empty($_POST['lieu'])){
        ...
        $query = $db->prepare('SELECT COUNT(*) FROM emplacement WHERE lieu = :lieu');
        ...
        if($count > 0){
            ...
            $query = $db->prepare('INSERT INTO emplacement(lieu) VALUES(:lieu)');
            $query->execute([
                'lieu' => $lieu,
            ]);
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header"><h3 class="text-center font-weight-light my-3">Ajouter un emplacement</h3></div>
                                <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" name="lieu" id="inputLieu" type="text" value="<?= isset($lieu) ? htmlspecialchars($lieu) : ''; ?>" placeholder="Nom emplacement" required />
                                            <label for="inputLieu">Nom emplacement</label>
                                        </div>
                                        <div class="mt-4 mb-0">
