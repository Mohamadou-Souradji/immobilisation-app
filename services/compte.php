...
// Récupérer la liste des matières avec les noms et prénoms des enseignants
$query = $db->query("SELECT id_famille, nom_famille,type_immobilisation,duree_vie,coefficient,taux,type,compte FROM famille_immobilisation f , amortissement a WHERE f.id_amortissement=a.id_amortissement");
$listefamille = $query->fetchAll(PDO::FETCH_OBJ);
/*if(isset($_GET['id_mat'])){
    $query = $db->prepare('DELETE FROM matieres WHERE id_mat=:id_mat');
    $query->execute(['id_mat' => $_GET['id_mat']]);
}*/
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Comptes des immobilisations</title>
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="card mb-4">
                            <div class="card-header">
                               ...
                               Tableau des comptes immobilisation
                            </div>
                            <div class="card-body">
