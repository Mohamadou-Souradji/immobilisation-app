...
// Vérifier si l'ID de fournisseur à supprimer est passé en paramètre GET
if(isset($_GET['id_fournisseur'])){
    // Supprimer le fournisseur correspondant dans la base de données
    $query = $db->prepare('DELETE FROM compte_fournisseur WHERE id_fournisseur=:id_fournisseur');
    $query->execute(['id_fournisseur' => $_GET['id_fournisseur']]);
    
    // Rediriger vers la liste des fournisseurs après la suppression
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="d-flex align-items-center justify-content-center mt-4 mb-4">
                                            <button type="submit" name="submit" class="btn btn-success"><a href="add_fournisseur.php" class="btn btn-success">Ajouter <i class="fa-solid fa-plus  "></i></a></button>
                                            </div>
                            ...
                            <div class="card-body">
                                <table class="table table-success table-striped table-bordered " id="datatablesSimple">
                                    ...
                                    <?php foreach($listeFournisseur as $fournisseur): ?>
                                        <tr>
                                            <th><?=  $fournisseur->id_fournisseur; ?></th>
                                            <td><?=$fournisseur->nom_fournisseur; ?></</td>
                                            <td>
                                            <a href="modifier_fournisseur.php?id=<?= $fournisseur->id_fournisseur; ?>" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="fournisseur.php?id_fournisseur=<?= $fournisseur->id_fournisseur; ?>" onClick="return confirm('Confirmer la suppression')" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                                </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
