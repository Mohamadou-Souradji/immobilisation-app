...
$query = $db->query("SELECT cession.*,immobilisation.id_immobilisation ,immobilisation.intitule FROM cession JOIN immobilisation ON cession.id_immobilisation = immobilisation.id_immobilisation");
$cessions = $query->fetchAll(PDO::FETCH_OBJ);
...
<head>
    ...
    <title>Liste des Cessions</title>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="d-flex align-items-center justify-content-center mt-4 mb-4">
                    <a href="cession.php" class="btn btn-success">Ajouter <i class="fa-solid fa-plus"></i></a>
                </div>
                <div class="card mb-4">
                        ...
                        <table class="table table-success table-striped table-bordered " id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php foreach($cessions as $cession): ?>
                                        <tr>
                                            <td><?= $cession->intitule ?></td>
                                            <td><?= $cession->date_cession ?></td>
                                            <td><?= $cession->prix_vente ?></td>
                                            <td><?= $cession->autres_infos ?></td>
                                            <td><a href="cessionlist.php?id_immobilisation=<?= $cession->id_immobilisation ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette facture?')"><i class="fa-solid fa-trash"></i></a></td>
