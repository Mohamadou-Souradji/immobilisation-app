...
// Vérifier si l'ID d'utilisateur à supprimer est passé en paramètre GET
if(isset($_GET['id'])){
...
// Récupérer la liste des amortissements
$query = $db->query("SELECT id,login,password from utilisateur; ");
$listeUtilisateur = $query->fetchAll(PDO::FETCH_OBJ);
    ...
    <div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div id="layoutSidenav_content">
                ...
                <button type="submit" name="submit" class="btn btn-success"><a href="add_utilisateur.php" class="btn btn-success">Ajouter <i class="fa-solid fa-plus  "></i></a></button>
                                            </div>
                                ...
                                <table class="table table-success table-striped table-bordered " id="datatablesSimple">
                                    ...
                                    <?php foreach($listeUtilisateur as $utilisateur): ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="modifier_utilisateur.php?id=<?= $utilisateur->id; ?>" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="utilisateur.php?id=<?= $utilisateur->id; ?>" onClick="return confirm('Confirmer la suppression')" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                        </tr>                                                                   
                                     <?php endforeach; ?>
                                    </tbody>
