...
$query = $db->query("SELECT id_amortissement, type FROM amortissement");
$listeAmortissemnt = $query->fetchAll(PDO::FETCH_OBJ);
                ...
                <main>
                    <div class="card mb-4">
                        ...
                        <table class="table table-success table-striped table-bordered " id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php foreach($listeAmortissemnt as $amortissement): ?>
                                        <tr>
                                            <td><?= htmlspecialchars($amortissement->id_amortissement); ?></td>
                                            <td><?= htmlspecialchars($amortissement->type); ?></td>
